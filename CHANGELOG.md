...
- Detect Cloudflare 525 SSL handshake failures and show origin TLS troubleshooting suggestions (`sudo nginx -T`, `openssl s_client`, Cloudflare SSL/TLS mode guidance).
