...
- Install section updated to PyPI-first (`pip install deploydoctor` / `pipx install deploydoctor`).

## 0.1.1

### Fixed

- All relative links in README replaced with absolute GitHub URLs for correct rendering on PyPI.
